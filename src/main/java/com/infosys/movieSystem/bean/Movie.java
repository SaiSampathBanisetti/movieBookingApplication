...
public class Movie {
	...
	public Movie(String movieId,String movieName, String language,String genre, Integer duration, Double ratings, String posterUrl) {
		super();
		this.movieId= movieId;
	...
	public String toString() {
		return "Movie [movieId=" + movieId + ", movieName=" + movieName + ", language=" + language + ", genre=" + genre
				+ ", duration=" + duration + ", ratings=" + ratings + ", posterUrl=" + posterUrl + "]";
	}
